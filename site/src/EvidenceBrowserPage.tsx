  ...
  return (
    <div className="evidence-page">
      <section className="evidence-hero">
        <div>
          <p className="eyebrow">WEB-010 · Evidence browser</p>
          <h1>De una afirmación al archivo que la sostiene</h1>
          <p>
            Busca un hallazgo, módulo, gen, TSV o script y recorre la cadena de trazabilidad
            hasta sus fuentes, parámetros, hashes y commit exacto de construcción.
          </p>
        </div>
      </section>
      ...
      {data && (
        <>
          ...
          <section className="evidence-claims">
            <div className="evidence-section-heading">
              <div>
                ...
                <h2>Mapa afirmación → evidencia</h2>
              </div>
          ...
          <section className="evidence-catalog">
            <div className="evidence-section-heading">
              <div>
                <p className="eyebrow">Provenance global</p>
