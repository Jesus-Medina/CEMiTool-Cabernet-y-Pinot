...
# Soft-thresholding power is fixed explicitly at beta = 7.
#
# Outputs:
...
writeLines(
  c(
    ...
    "",
    "Automatic beta selection did not identify a usable value in the initial baseline run. To reproduce the established 54-sample baseline, the soft-thresholding power was fixed explicitly at **beta = 7** using `set_beta = 7` and `force_beta = FALSE`. This value is specific to the present expression matrix and should be re-evaluated if the sample set, normalization, or filtering changes. The recorded beta for this run is **`r beta`**.",
    "",
    "```{r parameters-table}",
...
message(
  "Complete workflow finished. Beta was fixed at 7. ",
