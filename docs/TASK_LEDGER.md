...
**Methods decoration stability and header spacing follow-up (2026-09-24):** la decoración de Métodos recupera su posición original en el margen izquierdo, pero dejó de usar el alto variable de la página y `object-fit: cover`; ahora conserva las proporciones intrínsecas del asset, permite que sus hojas sobresalgan sin un recorte rectangular y permanece fuera del flujo del contenido, sin deformación al abrir evidencias. Se aumentó a 10 px la separación entre enlaces primarios y herramientas del header. La prueba de navegador compara la geometría de la vid antes/después de desplegar una evidencia, además de verificar el espaciado del header. No cambió ningún dato ni inferencia científica.
