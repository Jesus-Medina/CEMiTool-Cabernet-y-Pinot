...
**Immediate next step:** WEB-005 M5 coexpression network + chromosome 16 locus view, using only canonical network/annotation coordinates and preserving non-causal interpretation.
